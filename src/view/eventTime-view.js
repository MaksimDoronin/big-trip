...
export default class EventTimeView {
  ...
  getElement() {
     ...
     * 1. Конструктора нет → при new EventTimeView объект пустой, this.element = undefined.
     * 2. Первый вызов eventTimeView.getElement():
     ...
     *
     * 3. Второй вызов eventTimeView.getElement():
